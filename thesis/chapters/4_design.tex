...
% Syns alltid left-recursion er vanskelig å forklare men tenk det her. vi fyller hele tiden inn expression med structfield og vice versa. vi leser ikke noe faktisk input, vi bygger bare et giga ast.
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=.75]{assets/chapter5/SimpleProgram_ibp.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=.75]{assets/chapter5/ForEachProgram_ibp.pdf}
...
There are again two edges: The first is labeled \texttt{true} and points to the subsequent statement following the current \texttt{\textbf{While}} (if there are any). The other is labeled \texttt{false} and points to the first statement in \texttt{statements}. The last of these points back to the light yellow rectangle. A working example is presented in \Cref{flochartWhile}. \\

\begin{figure}[ht]
    \centering
    \includegraphics[scale=.75]{assets/chapter5/WhileProgram_ibp.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=.62]{assets/chapter5/ForProgramPositive_ibp.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=.62]{assets/chapter5/ForProgramNegative_ibp.pdf}
    \caption{A \texttt{For}-statmenet where \texttt{from > to}.}
    \label{forExample2}
\end{figure}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[scale=.62]{assets/chapter5/ForProgramDefault_ibp.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=.72]{assets/chapter5/IfElseProgram_ibp.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=.72]{assets/chapter5/SimpleIfProgram_ibp.pdf}
